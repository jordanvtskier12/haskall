...
allIntegersInclusive a b = if a < b then [a..b] else reverse [b..a] 
...
allIntegersExcludingFirst a b = if a < b then [a+1..b] else reverse [b..a-1] 
...
isRigid n = sum (digits n) == product (digits n)
